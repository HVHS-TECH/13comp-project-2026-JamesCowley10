/*************************************************************
  ...
  Written by Mr Bob, Term 1 2020, Adapted By James Cowley, Term 1 2026
  ...
  Develop a basic W3.CSS interface.
    ...
    v22   Replace DB button with ZZ button to stop confusion
    ...
    v24   Replace ZZ with ZZ to stop confusion
...
import { fb_initialise, fb_onAuthStateChanged }
...
const AD_BTN_ZZ = document.getElementById("b_ad_ZZ");
...
/**************************************************************/
// ad_ZZ()
// Input event; called when admin's ZZ button clicked
// Display ZZ (Bouncing Ball) admin screen
// Input:  n/a
// Return: n/a
/**************************************************************/
export function ad_ZZ() {
  console.log('%c ad_ZZ(): ',
    'color: ' + AD_COL_C + '; background-color: ' + AD_COL_B + ';');
...
/**************************************************************/
// ad_processZZReadAll(_result, _path,  _snapshot, _save, _error)
// Called by ad_readAll() to handle result of read ALL ZZ records request.
// Save data & update display with record info
// Input:  result('waiting', 'OK', 'error'), path, 
//         snapshot, where to save it & error msg if any
//         NOTE: This is the raw data, EG snapshot, and
...
/**************************************************************/
//                 _procFunc(_result, _path, _snapshot, _save, _error)
function ad_processZZReadAll(_result, _path, _snapshot, _save, _error) {
  console.log('%c ad_processZZReadAll(): result= ' + _result,
    'color: ' + AD_COL_C + '; background-color: ' + AD_COL_B + ';');
